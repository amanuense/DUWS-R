...
index_amount_zones_5 = lbAdd [2102, "5 (default)"];
...
lbSetCurSel [2102, index_amount_zones_5];
...
index_blufor_ap_200 = lbAdd [2104, "200 (pay to win)"];
...
index_weather_type_mediterranean = lbAdd [2106, "Mediterranean (default)"];
...
index_max_dist_hq_200 = lbAdd [2188, "20 km (default)"];
...
lbSetCurSel [2188, index_max_dist_hq_200];
