...
if (!Mission_timeout_request) exitWith {PAPABEAR=[West,"HQ"]; PAPABEAR SideChat "We don't have any other missions for you right now, try again later.";};

if (!isFormationLeader player) exitWith {hint "Only the leader can request side missions for now"};
    ...
    if (_foundsafePos distance player > 1500
        ...
        switch (_counter) do {
            case 0: { // mission RESCUE
                ...
                _radius = 300;
                MissionNameCase0 = [0] call compile preprocessFile "misc\random_name.sqf";
            ...
            case 1: { // mission STEAL
                //add the mission into the strat map
                _radius = 300;
                MissionNameCase1 = [0] call compile preprocessFile "misc\random_name.sqf";
            ...
            case 2: { // mission TARGET
                //add the mission into the strat map
                _radius = 300;
                MissionNameCase2 = [0] call compile preprocessFile "misc\random_name.sqf";
            ...
            case 3: { // mission DESTROY
                //add the mission into the strat map
                _radius = 300;
                MissionNameCase3 = [0] call compile preprocessFile "misc\random_name.sqf";
            ...
            case 4: { // mission PILOT
                //add the mission into the strat map
                _radius = 300;
                MissionNameCase4 = [0] call compile preprocessFile "misc\random_name.sqf";
            ...
            case 5: { // mission SABOTAGE
                //add the mission into the strat map
                _radius = 300;
                MissionNameCase5 = [0] call compile preprocessFile "misc\random_name.sqf";
...
[(findDisplay 46), getPosWorld player, _array_of_missions, [], [], [], 1, _isNight] call BIS_fnc_strategicMapOpen;