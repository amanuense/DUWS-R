//note this file is a duplicated of fob_ammobox.sqf
...
waitUntil {sleep 1; getPosWorld _ammo select 2<0.2};
_smoke = "SmokeShellGreen" CreateVehicle (getPosWorld _ammo);
