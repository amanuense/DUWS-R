...
diag_log format["support\createopteam.sqf"];

// hint format["%1",_position];
_safePosition = [_position, 10, 50, 3, 0, 1, 0] call BIS_fnc_findSafePos;
_group = [_safePosition, EAST, ["O_Soldier_TL_F","O_Soldier_AR_F","O_Soldier_LAT_F","O_Soldier_GL_F"],[],[],opfor_ai_skill] call BIS_fnc_spawnGroup;
